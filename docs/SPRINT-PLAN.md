...
| Ticket | Owner | What to build |
|---|---|---|
| RD-115 | Dev A | Spec walkthrough page-by-page — every screen/button in the design/API docs exists; fix gaps found; **must pass Jira-like UX check** ([UI-UX-JIRA.md](UI-UX-JIRA.md)) |
